...
- Adjustable `2` to `10` up library grid with a `6` up default, hover-revealed card metadata, multi-select batch organization, and a single-asset viewer overlay opened from the grid.
